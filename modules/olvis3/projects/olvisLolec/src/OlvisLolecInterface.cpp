...
#include "OlvisLolecInterface.h"

#include <QtPlugin>
#include <OlvisCoreInterface.h>
#include "OlvisLolec.h"

OlvisLolecInterface::OlvisLolecInterface()
{
}
...
QObject* OlvisLolecInterface::instance(RcBase &rc, const QString &configFile, const QString& /* name */)
{
    Q_UNUSED(configFile);
    ...
    return new OlvisLolec();
}

#if QT_VERSION < 0x050000
Q_EXPORT_PLUGIN2(OlvisLolecInterface, OlvisLolecInterface)
#endif

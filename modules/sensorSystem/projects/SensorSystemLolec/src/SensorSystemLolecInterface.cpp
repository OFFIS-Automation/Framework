...
#include "SensorSystemLolecInterface.h"
#include "SensorSystemLolec.h"
#include <QtPlugin>

SensorSystemLolecInterface::SensorSystemLolecInterface()
{
}

QString SensorSystemLolecInterface::description() const
{
...
QObject *SensorSystemLolecInterface::instance(RcBase &rc, const QString &, const QString &)
{
...
Q_EXPORT_PLUGIN2(SensorSystemLolecInterface, SensorSystemLolecInterface)
#endif

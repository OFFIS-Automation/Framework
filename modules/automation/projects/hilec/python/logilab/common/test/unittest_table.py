...
class TableTC(TestCase):
    ...
    def test_get_rows(self):
        ...
        self.assertEqual(self.table[:], [[0, 0], [0, 0], [0, 0]])
        self.table.insert_column(1, list(range(3)), 'supp')
    ...
    def test_set_column(self):
        ...
        """
        self.table.set_column(0, list(range(3)))
    ...
    def test_set_column_by_id(self):
        ...
        """
        self.table.set_column_by_id('col1', list(range(3)))
        self.assertEqual(self.table[0, 0], 0)
        self.assertEqual(self.table[1, 0], 1)
        self.assertEqual(self.table[2, 0], 2)
        self.assertRaises(KeyError, self.table.set_column_by_id, 'col123', list(range(3)))
    ...
    def test_insert_column(self):
        ...
        """
        self.table.insert_column(1, list(range(3)), "inserted_column")
    ...
    def test_transpose(self):
        ...
        """
        self.table.append_column(list(range(5, 8)), 'col3')
